...
# This file was *autogenerated* from the file ./eval_gs_norms.sage
from sage.all_cmdline import *   # import sage library

_sage_const_2 = Integer(2); _sage_const_0 = Integer(0); _sage_const_1 = Integer(1); _sage_const_106 = Integer(106); _sage_const_4 = Integer(4); _sage_const_5 = Integer(5)#!/usr/bin/env sage
...
def print_data_line(f_out, data):
    RRout = RealField(_sage_const_106 );
    #f_out.write(("{:d}"+"\t{}"*4+"\n").format(data[0], *[RRout(_d) for _d in data[1:5]]));
    f_out.write(("{:d}"+"\t{:14.12f}"*_sage_const_4 +"\n").format(data[_sage_const_0 ], *[float(_d) for _d in data[_sage_const_1 :_sage_const_5 ]]));
    f_out.flush();
...
for typ in typ_list:
    ...
    _prev_ln    = RealField(work_prec)(_sage_const_1 );
    _prevBKZ_ln = RealField(work_prec)(_sage_const_1 );
